    ...
    <>
      <div className={styles.box}>
        <div className={styles.gps1}>
          <button className={styles.gps1Btn} onClick={postAddressData_1}>
            +
          </button>
          <button className={styles.gps1Btn} onClick={getAddressBtn}>
            조회
          </button>
          <button className={styles.gps1Btn} onClick={deleteAddress_1}>
            delete
          </button>
          <TextInput
            placeholder={"첫번째 주소를 입력해주세요"}
        ...
        <div className={styles.gps1}>
          <button className={styles.gps1Btn} onClick={postAddressData_2}>
            +
          </button>
          <button className={styles.gps1Btn} onClick={getAddressBtn}>
            조회
          </button>
          <button className={styles.gps1Btn} onClick={deleteAddress_2}>
            delete
          </button>
          <TextInput
            placeholder={"두번째 주소를 입력해주세요"}
